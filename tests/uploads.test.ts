import fs from 'fs';
import type { ResponseLike } from 'miriam-example/internal/to-file';
import { toFile } from 'miriam-example/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('miriam-example/core/uploads');
    await expect(
